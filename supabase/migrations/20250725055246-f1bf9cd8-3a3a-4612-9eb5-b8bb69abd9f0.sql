-- Make author_id nullable temporarily so we can insert sample articles
ALTER TABLE public.articles ALTER COLUMN author_id DROP NOT NULL;

-- Insert sample articles without author_id
INSERT INTO public.articles (title, content, excerpt, likes_count) VALUES
(
...
(
  ...
  <ul>
    ...
    <li>Informal administrative capacity for monitoring and enforcement</li>
