            ...
            {loading ? (
              ...
              filteredArticles.map((article, index) => (
                ...
                >
                  <div className="flex-1">
                    <h2 className="text-xl font-semibold mb-3 text-primary group-hover:text-accent transition-colors line-clamp-2">
                      {article.title}
                    </h2>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 z-20 pointer-events-none rounded-2xl">
                    <div className="text-lg font-semibold text-accent bg-background/95 px-6 py-3 rounded-lg shadow-lg backdrop-blur-sm border border-accent/30 transform scale-95 group-hover:scale-100 transition-transform duration-300">
                      Read More
                    </div>
                  </div>
                </div>
              ...
              <div className="col-span-full text-center py-16">
                <div className="glass p-12 rounded-3xl max-w-md mx-auto">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-primary">No articles found</h3>
                  <p className="text-secondary">
