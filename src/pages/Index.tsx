  ...
  return (
    <div className="page-container">
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    <div className="mx-auto w-16 h-16 academic-gradient rounded-2xl flex items-center justify-center mb-4 shadow-lg">
        ...
        <section className="py-20">
          <div className="container">
            <h2 className="scholarly-text text-3xl md:text-4xl font-bold mb-12 text-center">
              Get Started
            </h2>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 academic-gradient rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
      ...
      <footer className="glass mt-20 py-12">
        <div className="container text-center">
          <div className="scholarly-text text-2xl font-bold mb-4">
